            ...
            <ErrorBoundary>
              <BrowserRouter>
                <Routes>
                  ...
                  <Route path="/announcements" element={<ProtectedRoute><DashboardLayout><RequirePermission permission="canViewAnnouncements" module="announcements" title="Announcements"><Suspense fallback={<div className="p-8 text-center">Loading...</div>}><Announcements /></Suspense></RequirePermission></DashboardLayout></ProtectedRoute>} />
