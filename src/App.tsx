            ...
            <ErrorBoundary>
              <BrowserRouter>
                <Routes>
                  ...
                  <Route path="/members" element={<ProtectedRoute><DashboardLayout><RequirePermission permission="canViewMembers" module="members"><Suspense fallback={appFallback}><Members /></Suspense></RequirePermission></DashboardLayout></ProtectedRoute>} />
                  <Route path="/meetings" element={<ProtectedRoute><DashboardLayout><RequirePermission permission="canViewMeetings" module="meetings"><Suspense fallback={appFallback}><Meetings /></Suspense></RequirePermission></DashboardLayout></ProtectedRoute>} />
                  <Route path="/finance" element={<ProtectedRoute><DashboardLayout><RequirePermission permission="canViewFinance" module="finance"><Suspense fallback={appFallback}><Finance /></Suspense></RequirePermission></DashboardLayout></ProtectedRoute>} />
                  <Route path="/finances" element={<ProtectedRoute><DashboardLayout><RequirePermission permission="canViewFinance" module="finance"><Suspense fallback={appFallback}><Finance /></Suspense></RequirePermission></DashboardLayout></ProtectedRoute>} />
