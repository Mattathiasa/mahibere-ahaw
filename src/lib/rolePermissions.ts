...
export const PERMISSION_META: Record<PermissionKey, PermissionMeta> = {
  ...
  canViewTeachings: { labelKey: 'canViewSermonsLabel', descriptionKey: 'canViewSermonsDesc', group: 'Pages' },
  ...
  canCreateTeaching: { labelKey: 'canCreateSermonLabel', descriptionKey: 'canCreateSermonDesc', group: 'Sermons' },
  canEditTeaching: { labelKey: 'canEditSermonLabel', descriptionKey: 'canEditSermonDesc', group: 'Sermons' },
  canDeleteTeaching: { labelKey: 'canDeleteSermonLabel', descriptionKey: 'canDeleteSermonDesc', group: 'Sermons' },
